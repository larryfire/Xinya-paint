...
export default function ExternalPlateCostPage() {
  ...
  const [form, setForm] = useState({
    shipId: "", supervisorId: "", dockEntryTime: "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success) {
        setDialogOpen(false)
        setForm({ shipId: "", supervisorId: "", dockEntryTime: "", area: "", teamId: "", settlementCost: "", constructionCost: "", remarks: "" })
        fetchCosts()
      }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">外板成本管控</h1>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>进坞时间</TableHead><TableHead>区域</TableHead><TableHead>队伍</TableHead>
                  ...
                  {costs.length === 0 ? (
                    ...
                    <TableRow key={c.id}>
                      ...
                      <TableCell className="text-right">
                        <Badge variant={c.profitLoss! >= 0 ? "default" : "destructive"}>
                          {formatCurrency(c.profitLoss!)}
                        </Badge>
                      </TableCell>
                      <TableCell className="text-right">
                        <span className={c.profitLossRate! >= 0 ? "text-green-600" : "text-red-600"}>
                          {c.profitLossRate!.toFixed(2)}%
                        </span>
                      </TableCell>
                    </TableRow>
                  ))}
